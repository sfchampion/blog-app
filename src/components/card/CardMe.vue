<template>
  <el-card>
    <h1 class="me-author-name">sfChampion</h1>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '1844623978'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="https://space.bilibili.com/484460420">https://space.bilibili.com/484460420</a>'
        }
      }
    },
    methods: {
